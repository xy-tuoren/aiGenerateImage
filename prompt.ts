export function getAppDefaultPrompt({ appName, lang, prompt }: { appName?: string; lang?: string; prompt?: string;[key: string]: any }) {
...
export function getAppDefaultPrompt2({ appName, lang, prompt }: { appName?: string; lang?: string; prompt?: string;[key: string]: any }) {
...
//参考图与生成图比例不一样
export function getReferencePrompt({ appName, lang, prompt }: { appName?: string; lang?: string; prompt?: string;[key: string]: any }) {
...
export function getTextTranslatePrompt({ lang, prompt }: { lang?: string; prompt?: string;[key: string]: any }) {
